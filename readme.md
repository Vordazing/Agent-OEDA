...
<li>Используйте официальные контенизированный образ GitLab</li>
<li>отредактируйте compose file для установки нужных параметров.</li>
<li>Запустите docker compose up</li>
<li>Для получения рут пароля от гитлаба выполните команду:
docker exec -it gitlab-web-1 grep 'Password:' /etc/gitlab/initial_root_password</li>
